...
namespace Memory.Win32
{
    class MemoryHelper32
    {
        ...
        public bool WriteMemory<T>(uint MemoryAddress, T Value, int length)
        {
...
namespace Memory.Win64
{
    class MemoryHelper64
    {
        ...
        public bool WriteMemory<T>(ulong MemoryAddress, T Value, int length)
        {
            IntPtr bw = IntPtr.Zero;
    ...
    public static class ObjectType
    {
        ...
        public static byte[] GetBytes<T>(T Value)
        {
            ...
            switch (typename)
            {
                ...
                case "System.String":
                    return Encoding.ASCII.GetBytes((string)Convert.ChangeType(Value, typeof(string)));
                default:
                    return new byte[0];
            }
        }
